<div class="box-body">
    <div class='form-group{{ $errors->has("{$lang}.name") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("{$lang}[name]", old("{$lang}[name]", $old), ['class' => 'form-control', 'data-slug' => 'source', 'placeholder' => trans('Blogcategory.form.name')]) !!}
    ...
    <div class='form-group{{ $errors->has("{$lang}.slug") ? ' has-error' : '' }}'>
           ...
           {!! Form::text("{$lang}[slug]", old("{$lang}[slug]", $old), ['class' => 'form-control slug', 'data-slug' => 'target', 'placeholder' => trans('Blogcategory.form.slug')]) !!}

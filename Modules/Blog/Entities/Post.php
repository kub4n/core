...
class Post extends Model implements TaggableInterface {
    ...
    public $translatedAttributes = ['title', 'slug', 'content', 'meta_title', 'meta_description', 'og_title', 'og_description', 'og_type'];
    protected $fillable = ['category_id', 'status', 'title', 'slug', 'content', 'meta_title', 'meta_description', 'og_title', 'og_description', 'og_type'];

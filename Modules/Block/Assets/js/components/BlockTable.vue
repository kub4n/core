            ...
            <div class="box box-primary">
                <div class="box-body">
                    <data-tables :data="data" :actions-def="actionsDef">
                        ...
                        <el-table-column prop="title" :label="trans('blocks.title')">
                        </el-table-column>
    ...
    export default {
        data() {
            return {
                ...
                actionsDef: {
                    def: [{
                        name: this.trans('blocks.create-block'),
                        icon: 'edit',
                        handler: () => {
                            this.$router.push({name: 'admin.block.block.create'});
                        },
                    }],
                },
            };
        ...
        methods: {
            fetchData() {
                axios.get(route('api.block.block.index'))
                    .then((response) => {
